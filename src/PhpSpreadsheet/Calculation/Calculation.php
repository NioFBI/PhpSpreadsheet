...
class Calculation extends CalculationLocale
{
    ...
    private $instanceArrayReturnType = null;
    ...
    /** @var bool */
    private $processingAnchorArray = false;
    ...
    /** @var int */
    private static $matchIndex8 = 8;

    /** @var int */
    private static $matchIndex9 = 9;

    /** @var int */
    private static $matchIndex10 = 10;
